    ...
    <div style={{ padding: "2rem" }}>
      ...
      <div>
        {caseStudies.map((caseStudy) => (
          ...
          >
            <p className="text-red-400"> category : {caseStudy.category}</p>
            <h2 className="text-green-400">{caseStudy.title}</h2>
            <p className="text-yellow-400">{caseStudy.description}</p>
            {caseStudy.image && (
              <img
                src={caseStudy.image}
                alt={caseStudy.title}
